                    ...
                    {navigationItems.map((item) => (
                        ...
                        >
                            ...
                            <motion.button
                                ...
                                className={`relative flex flex-col items-center gap-1 p-3 rounded-xl transition-all duration-300 group ${activeView === item.id
